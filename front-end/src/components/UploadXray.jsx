...
function UploadXray() {
  ...
  return (
    <div className="min-h-screen bg-indigo-50 text-indigo-900 flex flex-col items-center justify-center">
      <div className="max-w-md w-full mx-auto p-8 bg-white rounded-lg shadow-md text-center">
        <h2 className="text-3xl font-bold mb-6 text-indigo-600">Upload Image</h2>
        ...
        {prediction && (
          <h2 className="text-xl text-indigo-900 mt-4">Prediction: {prediction}</h2>
        )}
      </div>
    </div>
  );

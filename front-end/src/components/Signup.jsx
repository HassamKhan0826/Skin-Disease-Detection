    ...
    <div className="min-h-screen flex items-center justify-center bg-indigo-50">
      <div className="bg-white text-gray-900 p-8 rounded shadow-md w-96">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-indigo-600 text-white p-3 rounded hover:bg-indigo-700 focus:outline-none"
          >
            Register
          </button>
          ...
          <Link
            to="/Login"
            className="block w-full bg-gray-500 text-white p-3 rounded mt-4 hover:bg-gray-600 focus:outline-none text-center"
          >
            Login
          </Link>
        </form>
